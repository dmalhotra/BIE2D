...
namespace sctl {
  ...
  template <class Real, Integer Order = 16> class DiscCapacitance : public ICIP<Real,Order> {
     ...
     */
    void Solve(Vector<Real>& Q, const Vector<Real>& V, const Real gmres_tol, const Long gmres_max_iter);
